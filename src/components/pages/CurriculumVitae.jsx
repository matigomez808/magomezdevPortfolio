...
export const CurriculumVitae = () => {
  ...
  return (
    <Suspense fallback='Loading...'>
      <Container layout="grid grid-cols-2">
        <Container>
          ...
          <ul>
            <li className="p-1 mt-2 border-b-2 border-[#006600] shadow-md">
          ...
          <Link
            className="rounded-xl bg-[#006600] p-3 text-center mt-4"
            href={pdfURL}
        ...
        <Container>
          ...
          <h2 className="text-xl font-light mt-1">{t(`cv.title`)}</h2>
          <h3 className="text-xl font-light mt-1">{t(`cv.location`)}</h3>
